...
# MeasurementSubsetOperator ------------------------------
#' @title Measurement Subset Operator
#' @export
#' @description operator to apply measurement subset operations 
#'
MeasurementSubsetOperator <- R6::R6Class(
  classname = "MeasurementSubsetOperator",
  inherit = SubsetOperator,
  private = list(
...
createMeasurementSubset <- function(name = NULL,
                              ...
                              unitConceptIds,
                              measurmentThresholds,
                              minLabValue = 0,
                              maxLabValue = 9999,
                              typeConceptIds = c(32856, 32836)) {
